...
process parse_pairs{
    ...
    script:
        ...
        """
        pairtools parse -c $params.chrSizes --add-columns mapq --nproc-in $nproc_pairsam --output-stats ${file_name}_stats.txt $bwa_sam | pairtools sort --memory $memory_sort -o ${file_name}.sorted.pairsam --nproc-out $nproc_out_sort  --nproc $nproc_sort
        """
}
